...
app.get('/products/:id', (req,res)=>{
	...
	client.query('SELECT products.id, products.name, products.description, products.tagline, products.price, products.warranty, products.image, products.category_id, products_category.name, products.brand_id, brands.name FROM products JOIN brands ON products.product_brand = brands.id ORDER BY products.id' , (req, data)=>{
		var list = [];
		//console.log(data);
